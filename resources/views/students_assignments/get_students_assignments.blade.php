                ...
                <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="true">
                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <div class="row">                               
                                <div class="col-sm-12">                                  
                                    <form class="form-horizontal" action="{{url('get-assignment-students-list')}}" enctype="multipart/form-data" method="GET">
                                        {{ csrf_field() }}                                                                               
                                        <div class="col-sm-12"><br>
                                            ...
                                            <div class="row" id="">
                                                ...
                                                <div class="col-sm-2">
                                                    <select  name="class_section_id" id="remark_classes"  class="">
                                                ...
                                                <div class="col-sm-2">
                                                    <select  name="subject_id" id="remark_subject" required class="">
                                                ...
                                                <div class="col-sm-2">
                                                    <button type="submit" class="width-10 btn btn-md btn-success">
                                                        ...
                                                        <span class="bigger-110">Get Classes</span>
                                                    </button>
                                                </div>
                                            </div>    
                                        </div>
