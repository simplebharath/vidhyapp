    ...
    <div id="content">
        <div class="">
            <ul class="nav nav-tabs">
                <li ><a href="{{url ('get-students-assignments')}}">Add Assignment</a></li>
                <li class="active"><a href="{{url ('view-class-assignments')}}">View Assignments</a></li>
            </ul>
        </div><br>
        <div class="row">
                                        ...
                                        foreach ($assignments as $assignment) {
                                            ...
                                            <tr class="">      
                                                ...
                                                <td><div class="btn-group">
                                                        <a href="{{ url('edit-assignment/'.$assignment->id)}}"title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></a>
                                                     @if(Session::get('user_type_id') == 1)    
                                                        <a href="{{ url('delete-assignment/'.$assignment->id) }}" onclick="return confirm('Are you sure to delete Assignment?');" title="Delete"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></a>
                                                    @endif
                                                    </div></td>
                                            </tr>
                                            <?php
