                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('do-add-class-fee')}}">
                                            {{ csrf_field() }}
                                                ...
                                                <div class="col-sm-8">
                                                    <select  name="fee_id" id="fee_id"  class="col-xs-10 col-sm-5 col-md-8 col-lg-8">
                                                        ...
                                                        <?php foreach ($fees as $fee) { ?>
                                                            <option value="{{$fee->id}}" @if(old('fee_id') == $fee->id ) selected @endif>{{ $fee->fee_title }} </option>
                                                        <?php } ?>
                                                    </select> 
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select   name="class_section_id[]" id="fee-classes" multiple="" style="height:300px;" class="col-xs-10 col-sm-5 col-md-8 col-lg-8" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 input">
                                                    <input type="number"  id="example1"  name="fee_amount" value="{{ old('fee_amount') }}"  class="col-xs-10 col-sm-5 col-lg-8 col-mg-8"/>
                                                </div>
                                                <div style="color: red;" id="error-message">
