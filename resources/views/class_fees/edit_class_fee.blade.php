            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="true">
                    <header>
                        ...
                        <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('view-class-fees')}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                    </header>
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('do-edit-class-fee/'.$class_fees[0]->id)}}">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select  name="fee_id" id="assign_feetype_id"  class="col-xs-10 col-sm-5 col-md-8 col-lg-8">                                                     
                                                            <option value="{{$class_fees[0]->fee_id}}" > {{ $class_fees[0]->fees->fee_title }} </option>                                                      
                                                    </select> 
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select   name="class_section_id"  class="col-xs-10 col-sm-5 col-md-8 col-lg-8" >
                                                         <option value="{{$class_fees[0]->class_section_id}}" > {{$class_fees[0]->class_sections->classes->class_name}} @if ($class_fees[0]->section_id >0 ) {{$class_fees[0]->class_sections->sections->section_name}} @endif </option>  
                                                    </select> 
                                                </div>
                                                <div style="color: red;" id="error-message">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <select  name="fee_type_id" id="assign_feetype_id"  class="col-xs-10 col-sm-5 col-md-8 col-lg-8">                                                     
                                                            <option value="{{$class_fees[0]->fee_type_id}}" > {{ $class_fees[0]->fee_types->fee_name }} </option>                                                      
                                                    </select> 
                                                </div>
                                                <div style="color: red;" id="error-message">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8 input">
                                                    <input type="number"  id="example1"  name="fee_amount" value="{{ $class_fees[0]->fee_amount }}"  class="col-xs-10 col-sm-5 col-lg-8 col-mg-8"/>
                                                </div>
                                                <div style="color: red;" id="error-message">
                                            ...
                                            <div style="margin-left:40%">
                                                ...
                                                <a href="{{ url('view-class-fees')}}" class="width-10 btn bg-color-blue txt-color-white">
                                                    <i class="ace-icon fa fa-undo"></i>
                                                    <span class="bigger-110">View class fees</span>
                                                </a>
                                            </div><br>
                                        </form>
                                    </div>
