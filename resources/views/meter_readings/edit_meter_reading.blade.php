            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="true">
                    <header>
                        ...
                        <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('view-meter-reading')}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{ url('do-edit-meter-reading/'.$meter_readings[0]->id) }}">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                    <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Meter reading<span class="error">* </span></label>                                               
                                                    <div class="col-sm-8 input">
                                                        <input type="text"  id="example1"  name="reading" value="{{$meter_readings[0]->reading}}" class="date col-xs-10 col-sm-5 col-lg-8 col-mg-8"/>
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 input">
                                                        <input type="text"  id="example1"  name="date" value="{{$meter_readings[0]->date}}" data-provide="datepicker"  class="date col-xs-10 col-sm-5 col-lg-8 col-mg-8"/>
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                                        {{ $errors->first('date') }}
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea cols="40" rows="3" maxlength="160" wrap="soft" class="col-xs-10 col-sm-5 col-md- col-lg-8" placeholder="" name="remarks" class="col-xs-10 col-sm-5 col-md-9 col-lg-9" >{{$meter_readings[0]->remarks}}</textarea>
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                            ...
                                            <div style="margin-left:40%">
                                                ...
                                                <a href="{{ url('view-meter-reading')}}" class="width-10 btn bg-color-blue txt-color-white">
                                                    <i class="ace-icon fa fa-undo"></i>
                                                    <span class="bigger-110"> View Meter Reading</span>
                                                </a>
                                            </div><br>
                                        </form>
                                    </div>
