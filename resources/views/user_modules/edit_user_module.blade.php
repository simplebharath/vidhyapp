            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="true">
                    <header>
                        ...
                        <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('view-user-types')}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-plus"></i> Add</a>
                    </header>
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('do-edit-user-module/'.$user_modules[0]->id)}}">
                                            {{ csrf_field() }}                                       
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Module <span class="error">* </span> </label>
                                                <div class="col-sm-9">
                                                    <select  name="module_id" id="section"  class="col-xs-10 col-sm-5 col-md-9 col-lg-9" >
                                                        <option value=""> --- select modules --- </option>
                                                        <?php foreach ($modules as $module) { ?>                                                        
                                                            <option value="{{$module->id}}" @if ($user_modules[0]->module_id == $module->id) selected="selected" @endif>{{ $module->module }} ( {{ $module->link }} ) - {{ $module->rank }}  -  [ {{ $module->image }} ] </option>
                                                        <?php } ?>
