            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">               
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="false">
                    <header>
                        ...
                        <h2>Add  Attendance @if($class_name =='') Of all students of the school @endif @if($class_name !='') Of Class  {{$class_name[0]->classes->class_name}} @if($class_name[0]->section_id > 0) {{$class_name[0]->sections->section_name}} @endif @endif @if($subject_id !="s")  @if($attendance_type[0]->id == 2)  Subject - {{ $subjects[0]->subject_name}} @endif @else - All subjects @endif</h2>
                        <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('add-student-attendance')}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-eye-open"></i> Add</a>
                    ...
                    <div>                                                                 
                        <div class="widget-body no-padding">
                            <div class="table-responsive">
                                <form class="form-horizontal" action="{{url('save-students-attendance')}}" enctype="multipart/form-data" method="POST" >
                                    {{ csrf_field() }}                                                           
                                    <table id="datatable_fixed_column" class="table table-condensed table-bordered" width="100%">
                                        ...
                                        <tbody>
                                            ...
                                            @else
                                            <input  hidden="" name="subject_id[<?php echo $student->id; ?>]" value="{{$subject_id}}" >
                                            @endif
                                            <td>@if($subject_id !="s"){{$subjects[0]->subject_name}} @else All subjects @endif</td>
                                            @endif
