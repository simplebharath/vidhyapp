            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">               
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="false">
                    <header>
                        ...
                        <h2>Edit  Attendance @if($class_name =='') Of all students of the school @endif @if($class_name !='') Of Class  {{$class_name[0]->classes->class_name}} @if($class_name[0]->section_id > 0) {{$class_name[0]->sections->section_name}} @endif @endif   @if($attendance_type[0]->id == 2)  Subject - {{ $subjects[0]->subject_name}} @endif </h2>
