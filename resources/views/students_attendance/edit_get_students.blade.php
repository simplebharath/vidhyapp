            ...
            <article class="col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="true">
                    <header>
                        ...
                        <h2 style="color:whitesmoke;">Edit<b> </b> Attendance @if($attendance_type[0]->id == 2){{$attendance_type[0]->title}} @endif </h2>
                                    ...
                                    <form class="form-horizontal" action="{{url('get_students_all')}}" enctype="multipart/form-data" method="POST">
                                        ...
                                        <div class="col-sm-12"><br>
                                            ...
                                            <div class="row" id="">
                                                ...
                                                <div class="col-sm-2">
                                                    <select  name="class_section_id" id="c_section_id"  class="">
                                                ...
                                                @endif
                                                <div class="col-sm-2">
                                                    <input type="text"  placeholder="Select date" name="attendance_date" data-provide="datepicker" class="form-controlhttp://portal.actcorp.in/web/hyd/home">
