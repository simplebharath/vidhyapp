                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
                            <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="false">
                                ...
                                <header>
                                    ...
                                    <h2> View <b> {{$students[0]->first_name}} {{$students[0]->last_name}}</b> Attendance of Month <b> {{ $month }} - {{ $year }} : {{ $subject_name }}</b></h2>    
                                    <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('view-student-monthly-attendance/'.$month.'/'.$students[0]->id)}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-arrow-left"></i>  Back </a>
                                    <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('view-student-attendance/'.$students[0]->id)}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-eye-open"></i>  Attendance </a>
                                </header>		
                                <div>
