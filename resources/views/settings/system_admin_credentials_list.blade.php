    ...
    <div id="content">
        ...
        <div class="">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="system_admin_credentials_list">System Admin</a></li>
        ...
        <div class="row">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                @if(Session::has('system_admin_password_change'))
                <div class="alert alert-success fade in">
                    <a href="#" class="close" data-dismiss="alert">&times;</a>
                    <strong>Success!</strong> {{ Session::get('system_admin_password_change') }}
                </div>
                @endif
                {{ Session::forget('system_admin_password_change') }}
                                            ...
                                            <tr class="">
                                               <td><img src='{{ asset('uploads/'.$user->photo) }}' onerror="this.onerror=null;this.src='{{ asset('uploads/2016-09-23-15-04-17-icon1.jpg') }}'" class="img-rounded" height="75" width="75"/></td>
                                                ...
                                                <td ><div class="btn-group">
                                                     <a href="{{ ('system_admin_credentials_change/'.$user->user_id) }} " ><button class="btn btn-default btn-primary"  ><span class="glyphicon glyphicon-retweet"></span>&nbsp;Change Credentials</button></a>
                                                    </div></td>
