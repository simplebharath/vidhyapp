    ...
    <div id="content">
        <div class="">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{url ('staff-get-students-remarks')}}">Add Remarks</a></li>
                ...
                <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="true">
                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <div class="row">                               
                                <div class="col-sm-12">                                  
                                    <form class="form-horizontal" action="{{url('staff-add-remarks-students')}}" enctype="multipart/form-data" method="POST">
                                        {{ csrf_field() }}                                                                               
                                        <div class="col-sm-12"><br>
                                            ...
                                            <div class="row" id="">
                                                ...
                                                <div class="col-sm-2">
                                                    <select  name="subject_id" id="su_id"  class="staff_c_section_id">
                                                ...
                                                <div class="col-sm-2">
                                                    <select  name="student_id" id="s_id"  class="">
