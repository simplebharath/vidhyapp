    ...
    <div id="content">
        <div class="">
            <ul class="nav nav-tabs">
                <li ><a href="{{url ('get-students-remarks')}}">Add Remarks</a></li>
                <li class="active"><a href="{{url ('view-students-remarks')}}">View Remarks</a></li>
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">              
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="false">
                    <header>
                        ...
                        <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('get-students-remarks')}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-plus-sign"></i> Add</a>
                    </header>
                    <div>
                                        ...
                                        foreach ($remarks as $remark) {
                                            ...
                                            <tr class="">
                                                ...
                                                <td><div class="btn-group">
                                                        <a href="{{ url('edit-remark/'.$remark->id)}}"title="Edit"><button class="btn btn-primary btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" ><span class="glyphicon glyphicon-pencil"></span></button></a>
                                                        @if(Session::get('user_type_id') == 1)
                                                        <a href="{{ url('delete-remark/'.$remark->id) }}" onclick="return confirm('Are you sure to delete Remarks?');" title="Delete"><button class="btn btn-danger btn-xs" data-title="Delete" data-toggle="modal" data-target="#delete" ><span class="glyphicon glyphicon-trash"></span></button></a>
                                                        @endif
                                                    </div></td>
                                            </tr>
                                            <?php
