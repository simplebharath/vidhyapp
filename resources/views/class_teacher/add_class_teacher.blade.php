...
<div id="main" role="main" >
    <div id="ribbon" >
        <ol class="breadcrumb col-md-3">
            <li>Home</li><li>Class Management</li>
        </ol>
                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('do-add-class-teacher/'.$class_sections[0]->id)}}">
                                            {{ csrf_field() }}                                       
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select   name="class_section_id" id="class_section_id"  class="col-xs-10 col-sm-5 col-md-9 col-lg-9" >
                                                        ...
                                                        <option value="{{ $class_sections[0]->id}}" >{{ $class_sections[0]->classes->class_name }}  @if(($class_sections[0]->section_id) != 0)  -  {{ $class_sections[0]->sections->section_name }}  @endif </option>
                                                ...
                                                <div class="col-sm-9">
                                                    <select  name="staff_id" id="section"  class="col-xs-10 col-sm-5 col-md-9 col-lg-9" >
                                                        ...
                                                        <?php foreach ($staffs as $staff) { ?>                                                        
                                                            <option value="{{$staff->id}}" @if (old('$staff_id') == $staff->id) selected="selected" @endif>{{ $staff->first_name }} {{ $staff->last_name }} </option>
                                                        <?php } ?>
