                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{ url('do-add-route-stop') }}">
                                            {{ csrf_field() }}                                       
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <select  name="route_id" id="cid"  class="col-xs-10 col-sm-5 col-md-8 col-lg-8">
                                                            ...
                                                            <?php foreach ($vehicle_routs as $vehicle_rout) { ?>
                                                                <option value="<?php echo $vehicle_rout->id; ?>" @if(old('route_id') == $vehicle_rout->id ) selected @endif>{{ $vehicle_rout->route_title}} : {{ $vehicle_rout->route_from}} - {{ $vehicle_rout->route_to}} </option>
                                                            <?php } ?>
                                                        </select> 
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 input">
                                                        <input type="text"  id="example1"  name="stop_name" value="{{ old('stop_name') }}" class="date col-xs-10 col-sm-5 col-lg-8 col-mg-8"/>
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 input">
                                                        <input type="text"  id="example1"  name="stop_latitude" value="{{ old('stop_latitude') }}" class="date col-xs-10 col-sm-5 col-lg-8 col-mg-8"/>
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 input">
                                                        <input type="text"  id="example1"  name="stop_longitude" value="{{ old('stop_longitude') }}" class="date col-xs-10 col-sm-5 col-lg-8 col-mg-8"/>
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text"  id="timepicker" placeholder=""  name="pickup_time"  value="{{old('pickup_time')}}" class=" col-xs-10 col-sm-5 col-lg-8 col-mg-8" />                                                        
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text"  id="timepicker1" placeholder="" value="{{old('drop_time')}}" name="drop_time" class="col-xs-10 col-sm-5 col-lg-8 col-mg-8" />
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <textarea cols="40" rows="2" maxlength="160" wrap="soft" class="col-xs-10 col-sm-5 col-md-8 col-lg-8" placeholder="" name="stop_address"  >{{ old('stop_address') }}</textarea>
                                                    </div>
                                                    <div style="color: red;" id="error-message">
