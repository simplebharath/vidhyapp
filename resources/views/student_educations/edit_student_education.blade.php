            ...
            <article class="col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="true">
                    <header>
                        ...
                        <h2 style="color:whitesmoke;">Edit <b> {{$student[0]->first_name}} {{$student[0]->middle_name}} {{$student[0]->last_name}}</b> Previous Education</h2>
                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="row">
                                ...
                                <div class="col-sm-12">                                  
                                    <form class="form-horizontal" action="{{url('do-edit-student-education/'.$student_educations[0]->student_id.'/'.$student_educations[0]->id)}}" enctype="multipart/form-data" method="POST">
                                        {{ csrf_field() }}                                                                               
                                        <div class="col-sm-12"><br>
                                            ...
                                            <div class="row" >
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="institute_name" value="{{$student_educations[0]->institute_name}}" placeholder="Institute name">
                                                    </select>
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="class_from" value="{{$student_educations[0]->class_from}}" placeholder="From calss">
                                                    <p class="help-block" style="color: red;">
                                                        {{ $errors->first('class_from') }}
                                                    </p>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="class_to" value="{{$student_educations[0]->class_to}}" placeholder="To class">
                                                    <p class="help-block" style="color: red;">
                                                        {{ $errors->first('class_to') }}
                                                    </p>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="from_year" value="{{$student_educations[0]->from_year}}" placeholder="From year">
                                                    <p class="help-block" style="color: red;">
                                                        {{ $errors->first('from_year') }}
                                                    </p>
                                                </div>                                                                                              
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="to_year" value="{{$student_educations[0]->to_year}}"" placeholder="To year">
                                                    <p class="help-block" style="color: red;">
                                        ...
                                        <div class="row" >
                                            ...
                                            <div class="col-sm-3">
                                                <textarea cols="55" rows="3" maxlength="500" name="education_description" placeholder="">{{$student_educations[0]->education_description}}</textarea>
                                                </select>
                                                <p class="help-block" style="color: red;">
                                        ...
                                        <div class="col-md-offset-4">
                                            <button type="submit" class="width-10 btn btn-md btn-success">
                                                ...
                                                <span class="bigger-110">Update student education</span>
                                            </button>
