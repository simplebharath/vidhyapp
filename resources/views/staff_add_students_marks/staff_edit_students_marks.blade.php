        ...
        <div class="row">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">              
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="false">
                   ...
                   <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('staff-marks-added-students')}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-arrow-left"></i> Back</a>
                    </header>
                    <div>
                        ...
                        <div class="widget-body no-padding">
                            <div class="table-responsive">
                                 <form class="form-horizontal" action="{{url('staff-update-students-marks/'.$marks[0]->exam_id .'/'.$marks[0]->class_section_id.'/'.$marks[0]->subject_id)}}" enctype="multipart/form-data" method="POST" >
                                    {{ csrf_field() }}                                                           
                                        ...
                                        foreach ($marks as $mark) {
                                            ...
                                            <tr class="">
                                               ...
                                               NAME: {{$mark->students->first_name}} {{$mark->students->last_name}}
                                                ...
                                                <td>
                                                    <input type="number" required="" name="marks_obtained[<?php echo $mark->student_id; ?>]" value="{{$mark->marks_obtained}}">
