                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('do-edit-institute-timings/'.$institute_timings[0]->id)}}">
                                            {{ csrf_field() }}                                       
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Title<span class="error">* </span></label>
                                                    <div class="col-sm-9">
                                                        <input type="text"   id="form-field-1" placeholder="" name="title" value="{{$institute_timings[0]->title}}"  class="col-xs-10 col-sm-5 col-lg-9 col-mg-9" />
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text"  id="timepicker" placeholder=""  name="class_start"   value="{{$institute_timings[0]->class_start}}" class=" col-xs-10 col-sm-5 col-lg-9 col-mg-9" />                                                        
                                                    </div>
                                                    <div style="color: red;" id="error-message">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text"  id="timepicker1" placeholder=""  value="{{$institute_timings[0]->class_end}}" name="class_end" class="col-xs-10 col-sm-5 col-lg-9 col-mg-9" />
                                                    </div>
                                                    <div style="color: red;" id="error-message">
