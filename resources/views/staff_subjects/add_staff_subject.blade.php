                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('do-add-staff-subject')}}">
                                            {{ csrf_field() }} 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9">
                                                    <select   name="class_section_id" id="c_s_id"  class="col-xs-10 col-sm-5 col-md-9 col-lg-9" >
