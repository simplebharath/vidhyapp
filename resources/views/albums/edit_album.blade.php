                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{ url('do-edit-album/'.$albums[0]->id) }}">
                                            {{ csrf_field() }}

                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Product<span class="error">* </span></label>                                       
                                                <div class="col-sm-5">
                                                    <input type="text"  id="form-field-1"  name="album_title"value="{{$albums[0]->album_title}}" class="date col-xs-10 col-sm-5 col-lg-8 col-mg-8" />
                                                </div>
