                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{ url('do-edit-percentage/'.$percentages[0]->id) }}">
                                            {{ csrf_field() }}

                                            <div class="form-group">
                                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Percentage From<span class="error">* </span></label>                                       
                                                <div class="col-sm-8">
                                                    <input type="number"  id="form-field-1"  name="percentage_from" value="{{$percentages[0]->percentage_from}}"  class="date col-xs-10 col-sm-5 col-lg-8 col-mg-8" required/>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="number"  id="form-field-1"  name="percentage_to" value="{{$percentages[0]->percentage_to}}"  class="date col-xs-10 col-sm-5 col-lg-8 col-mg-8" required/>
                                                </div>
                                                <div style="color: red;" id="error-message">
