                                ...
                                <div><br>
                                    <div class="widget-body no-padding">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <form  class="form-horizontal" role="form" method="POST" action="{{ url('do-edit-fee-discount/'.$discounts[0]->id) }}">
                                                        {{ csrf_field() }}       
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <select  name="fee_id" id="fee_discount_id"  class="col-xs-10 col-sm-5 col-md-8 col-lg-8">
                                                                        ...
                                                                        <option value="<?php echo $discounts[0]->fee_id; ?>"><?php echo $discounts[0]->fees->fee_title; ?></option>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-9">
                                                                <input type="number"  id="form-field-1" placeholder="" name="discount" value="{{$discounts[0]->discount}}" class="col-xs-10 col-sm-5 col-lg-8 col-mg-8" />
                                                            </div>
                                                            <div style="color: red;" id="error-message">
