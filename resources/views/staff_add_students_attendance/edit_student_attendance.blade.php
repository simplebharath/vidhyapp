            ...
            <article class="col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="true">
                    <header>
                        ...
                        <h2 style="color:whitesmoke;">Edit <b> {{$staff[0]->first_name}} {{$staff[0]->middle_name}} {{$staff[0]->last_name}}</b> Experience</h2>
                        <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{ url('add-staff-experience/'.$staff[0]->id )}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-eye-open"></i> View</a>
                    </header>
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="row">
                                ...
                                <div class="col-sm-12">                                  
                                    <form class="form-horizontal" action="{{url('do-edit-staff-experience/'.$staff_experiences[0]->staff_id.'/'.$staff_experiences[0]->id)}}" enctype="multipart/form-data" method="POST">
                                        {{ csrf_field() }}                                                                               
                                        <div class="col-sm-12"><br>
                                            ...
                                            <div class="row" id="dynamicQualification">
                                                ...
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="organisation_name" value="{{$staff_experiences[0]->organisation_name}}" placeholder="Organization name">
                                                    <p class="help-block" style="color: red;">
                                                        {{ $errors->first('organisation_name') }}
                                                    </p>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="position" value="{{$staff_experiences[0]->position}}" placeholder="Position">
                                                    <p class="help-block" style="color: red;">
                                                        {{ $errors->first('position') }}
                                                    </p>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="from_year" value="{{$staff_experiences[0]->from_year}}"  placeholder="From : month/year">
                                                    <p class="help-block" style="color: red;">
                                                        {{ $errors->first('from_year') }}
                                                    </p>
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="to_year" value="{{$staff_experiences[0]->to_year}}"  placeholder="To : month/year">
                                                    <p class="help-block" style="color: red;">
                                                        {{ $errors->first('to_year') }}
                                                    </p>
                                                </div>                                                                                             
                                                <div class="col-sm-2">
                                                    <input type="text" class="form-control" name="total_years" value="{{$staff_experiences[0]->total_years}}" placeholder="Total : 0 year 0 month">
                                                    <p class="help-block" style="color: red;">
                                ...
                                <div class="col-md-offset-4">
                                    <button type="submit" class="width-10 btn btn-md btn-success">
                                        ...
                                        <span class="bigger-110">Update staff experience</span>
                                    </button>
                                    ...
                                    <a href="{{ url('view-staff')}}" class="width-10 btn bg-color-blue txt-color-white">
                                        ...
                                        <span class="bigger-110">View staff experiences </span>
                                    </a>
                                </div><br>
                                </form>
                            </div>
