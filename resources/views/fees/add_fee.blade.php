                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{ url('do-add-fee') }}">
                                            {{ csrf_field() }}                                       
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label no-padding-right" for="form-field-1">Fee title<span class="error">* </span></label>                                               
                                                <div class="col-sm-8 input">
                                                    <input type="text"  id="example1"  name="fee_title" value="{{ old('fee_title') }}"  class="col-xs-10 col-sm-5 col-lg-8 col-mg-8"/>
                                                </div>
                                            ...
                                            <div style="margin-left:40%">
                                                ...
                                                <a href="{{ url('view-fees')}}" class="width-10 btn bg-color-blue txt-color-white">
                                                    ...
                                                    <span class="bigger-110">View fees</span>
                                                </a>
                                            </div><br>
                                        </form>
                                    </div>
