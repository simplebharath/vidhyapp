...
<div id="main" role="main" >
    <div id="ribbon" >
        <ol class="breadcrumb col-md-3">
            <li>Assignments</li><li>Students</li>
        </ol>
    ...
    <div id="content">
        <div class="">
            <ul class="nav nav-tabs">
                <li class="active"><a href="{{url ('staff-get-students-assignments')}}">Add Assignment</a></li>
            ...
            <article class="col-sm-12 col-md-12 col-lg-12">
                <div class="jarviswidget" id="wid-id-3" data-widget-editbutton="true">
                    <header>
                        ...
                        <h2 style="color:whitesmoke;">Add <b>Assignment </b> </h2>
                    ...
                    <div>
                        <div class="widget-body no-padding">
                            <div class="row">                               
                                <div class="col-sm-12">                                  
                                    <form class="form-horizontal" action="{{url('staff-get-assignment-students-list')}}"  enctype="multipart/form-data" method="GET">
                                        {{ csrf_field() }}                                                                               
                                                ...
                                                <div class="col-sm-2">
                                                    <select  name="class_section_id" id="staff_c_section_id" required class="">
                                                        ...
                                                        <?php foreach ($class_sections as $class_section) { ?>
                                                            <option value="{{$class_section->class_section_id }}" >{{ $class_section->classes->class_name }}  @if(($class_section->section_id) != 0)  -  {{ $class_section->sections->section_name}}  @endif </option>
                                                        <?php } ?>
                                                    </select>
...
<!--                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-2">
                                                    <button type="submit" class="width-10 btn btn-md btn-success">
                                                        ...
                                                        <span class="bigger-110">Add Assignment</span>
                                                    </button>
                                                </div>
                                            </div>    
                                        </div>
