        ...
        <div class="">
            <ul class="nav nav-tabs">
              <li><a href="{{url('get-students-marks')}}"> Add Marks</a></li>
                <li class="active"><a href="{{url ('view-students-marks')}}"> View Marks</a></li>
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">              
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="false">
                    <header>
                        ...
                        <a type="button" class="btn bg-color-blueLight txt-color-white btn-xs pull-right" href="{{url('get-students-marks')}}" style="margin-top: 5px;margin-right: 5px;"><i class="glyphicon glyphicon-plus-sign"></i> Add</a>
                                            ...
                                            <tr class="">
                                               ...
                                               NAME: {{$mark->students->first_name}} {{$mark->students->last_name}}
                                                ...
                                                <td id="marks">
                                                   ...
                                                   <i class="edit_marks fa fa-pencil" id="marks_{{$mark->student_id.'_'.$mark->exam_id.'_'.$mark->class_section_id.'_'.$mark->subject_id}}"></i>
                                                 </span></td>
