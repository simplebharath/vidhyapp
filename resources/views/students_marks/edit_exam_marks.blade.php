        ...
        <div class="row">
            ...
            <article class="col-xs-12 col-sm-12 col-md-12 col-lg-12">               
                <div class="jarviswidget " id="wid-id-3" data-widget-editbutton="false">
                    ...
                    <div class="col-sm-12">                                  
                        <form class="form-horizontal" action="{{url('edit-student-subject-marks')}}" enctype="multipart/form-data" method="GET">
                            {{ csrf_field() }}                                                                               
                            <div class="col-sm-12"><br>
                                ...
                                <div class="row" id="">
                                    ...
                                    <div class="col-sm-2">
                                        <select  name="class_section_id" id="view_exam_classes" required class="">
                                    ...
                                    <div class="col-sm-2">
                                        <select  name="subject_id" id="edit_exam_subject" required class="">
