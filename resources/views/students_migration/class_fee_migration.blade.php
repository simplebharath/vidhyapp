...
<div id="main" role="main" >
    <div id="ribbon" >
        <ol class="breadcrumb col-md-3">
            <li>Migration</li><li>Class Fee</li>
        </ol>
    ...
    <div id="content">       
        <div class="">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{url ('class-fee-migration')}}">Migrate Class-fee</a></li>
                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('save-migrated-class-fees')}}">
                                            {{ csrf_field() }}                                       
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Select Fee(s) <span class="error"> </span> </label>
                                                <div class="col-sm-4">
                                                    <select  name="class_fee_id[]" id="class_fees" multiple="" style="height:300px;" class="col-sm-12">
                                                ...
                                                <label class="col-sm-2 control-label no-padding-right" for="form-field-1">Selected Fees <span class="error"> </span> </label>
                                                <div class="col-sm-3">
                                                    <select  name="" id="migrated_class_fees"  multiple="" style="height:300px;"  readonly disabled="" class="col-sm-12">
