    ...
    <div id="content">       
        <div class="">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{url ('staff-migration')}}">Migrate Staff</a></li>
                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('save-migrated-staff')}}">
                                            {{ csrf_field() }}                                       
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Select Staff <span class="error"> </span> </label>
                                                <div class="col-sm-3">
                                                    <select  name="staff_id[]" id="staff_to_migrate" multiple="" style="height:330px;" class="col-sm-12">
                                                ...
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">selected Staff <span class="error"> </span> </label>
                                                <div class="col-sm-3">
                                                    <select  name="" id="migrated_staff"  multiple="" style="height:330px;"  readonly disabled="" class="col-sm-12">
