    ...
    <div id="content">       
        <div class="">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="{{url ('migrate-timings')}}">Migrated Timings</a></li>
                    ...
                    <div>
                        <div class="widget-body no-padding"><br>
                            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-10">
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <form  class="form-horizontal" role="form" method="POST" action="{{url('update-migrated-timings')}}">
                                            {{ csrf_field() }}                                       
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">Select Timings <span class="error"> </span> </label>
                                                <div class="col-sm-3">
                                                    <select  name="institute_timing_id[]" id="old_timings" required="" multiple="" style="height:330px;" class="col-sm-12">
                                                ...
                                                <label class="col-sm-3 control-label no-padding-right" for="form-field-1">selected Timings <span class="error"> </span> </label>
                                                <div class="col-sm-3">
                                                    <select  name="#" id="new_timings"  multiple="" style="height:330px;"  readonly disabled="" class="col-sm-12">
